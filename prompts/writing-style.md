# Writing style (Sterling)

Use this as the default writing voice for posts and site copy.

## Voice

- **Simple-worded**: short sentences, concrete nouns/verbs, minimal jargon.
- **Warm**: generous, human, assumes good intent.
- **Casual**: conversational cadence; contractions are fine.
- **Smart**: clear thinking, specific claims, real examples.
- **Snarky (light)**: dry humor, but never mean; punch up, not down.
- **Over-communicate**: state the point early, add context, and make next steps obvious.
...
- **What to do**: a checklist or steps.
- **Close**: repeat the thesis in different words.
...
- **Punctuation**: use “normal keyboard punctuation” only.
  ...
  - Avoid special symbols unless necessary for code.
